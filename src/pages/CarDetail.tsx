        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-md">
              ...
              {(car.first_registration || car.production_date || car.model_year || car.category || car.body_type || car.tax || car.doors || car.seats) && (
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 mt-6 pt-6 border-t">
                  ...
                  {car.doors && (
                    <div className="bg-gray-50 rounded-lg p-3">
                      ...
                      <div className="font-semibold text-gray-900">{car.doors}</div>
                    </div>
                  )}
                  {car.seats && (
                    <div className="bg-gray-50 rounded-lg p-3">
